				...
				<div className="grid gap-8 border-b border-slate-300 pb-10 md:grid-cols-2 xl:grid-cols-4">
					{FOOTER_COLUMNS.map((column) => (
						<div key={column.title}>
							<h2 className="mb-4 text-[22px] font-bold text-[#075c86]">{column.title}</h2>
					...
					<div>
						<h2 className="mb-3 text-[22px] font-bold text-[#075c86]">Kết nối với chúng tôi</h2>
						...
						<h3 className="mb-3 text-[18px] font-semibold text-[#075c86]">Tải ứng dụng cho điện thoại</h3>
						...
						<section key={officeGroup.city} className="border-b border-slate-300 pb-6 last:border-b-0 last:pb-0">
							...
							<div className="grid gap-6 md:grid-cols-2">
								{officeGroup.items.map((office) => (
									<article key={office.title} className="space-y-2 text-[17px]">
